...
worker.add_all(actors, rating_above=7.5, votes_above=300, retry=False)
worker.add_all(actors, rating_above=6, votes_above=100, manual=True, retry=False)
worker.add_all(actors, manual=True, retry=False)
